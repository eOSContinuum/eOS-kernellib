...
- **Every item carries an activation trigger** — the observable condition that starts the work. Wave 1 is complete: its five items hardened surfaces the platform already shipped, and each now appears in the shipped inventory below. Wave 2 and Wave 3 items wait on their named triggers.
