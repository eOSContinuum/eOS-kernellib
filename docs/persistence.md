...
- **[`docs/configuration.md`](configuration.md)**: `.dgd` configuration fields (`dump_file`, `dump_interval`, `swap_file`, `hotboot` tuple).
- **[`docs/operations.md`](operations.md)**: boot modes, failure-mode table.
