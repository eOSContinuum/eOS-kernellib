...
| `capability [delegable <cap> on\|off]` | Capabilities | List the capability store (principal count and delegable flag per capability); `delegable` flips the per-capability delegation gate (hosted by capabilityd) |
